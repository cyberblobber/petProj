# petProj + AWS S3 with Node.JS

A simple and fully working example of petProj and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @petProj-example/aws-nodejs start
```
